      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
              <a class="nav-link float-right" href="#">Register</a>
            </li>
          </ul>
        </div>
      </div>
            ...
            <form action="../action/registration.php" method="post">
                ...
                <div class="row">
                    <div class="col-md-8 pt-1 mb-3 form-check">
                        <label class="form-check-label" for="exampleCheck1">You do not have an account? <a href=""> Register Here !</a></label>
                    </div>
                    <div class="col-md-4">
